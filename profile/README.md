...
| :------ | :----------- | :----- |
| **[AmritaCore](https://github.com/AmritaBot/AmritaCore)** | High‑performance Agent runtime core — pluggable, event‑driven, lightweight, and concurrent‑first | **✅ Production‑ready** |
| **[AmritaSense](https://github.com/AmritaBot/AmritaSense)** | General‑purpose workflow orchestration engine — the **support library and runtime for Core**. ISA‑based, with native `GOTO`/`CALL`, `PointerVector` addressing, and async interrupt | **✅ Available** |
| **[AmritaBot](https://github.com/AmritaBot/AmritaBot)** | Full‑stack LLM Agent chatbot (built on NoneBot2) — WebUI, multi‑adapter, permission system | **🚧 Usable, but no i18n** (by design: it’s our **tech experimentation platform**, keeping the core lean and fast‑iterating) |
...
- **Anchor responsibility in humans** — AI assists, but final decisions stay with people (see [AACLP](./POLICY_OF_AIGC))
